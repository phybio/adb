...
int adb_auth_generate_token(void *token, size_t token_size)
{
    ...
    fclose(f);
    printf("function = %s, file = %s, line = %u, ret * token_size = %d \n", __FUNCTION__, __FILE__, __LINE__, ret * (int)token_size);
...
void adb_auth_confirm_key(unsigned char *key, size_t len, atransport *t)
{
    ...
    printf("function = %s, file = %s, line = %u, framework_fd = %d,  adb_auth_event = %p\n", __FUNCTION__, __FILE__, __LINE__, framework_fd, adb_auth_event);
...
static void adb_auth_listener(int fd, unsigned events, void *data)
{
    ...
    printf("function = %s, file = %s, line = %u, s = %d, after adb_socket_accept \n", __FUNCTION__, __FILE__, __LINE__, s);
    ...
    if (needs_retry) {
        needs_retry = false;
        printf("function = %s, file = %s, line = %u, before send_auth_request\n", __FUNCTION__, __FILE__, __LINE__);
...
void adb_auth_init(void)
{
    ...
    printf("function = %s, file = %s, line = %u, before listen \n", __FUNCTION__, __FILE__, __LINE__);
    ...
    printf("function = %s, file = %s, line = %u, before fdevent_install, android_get_control_socket, fd = %d,  adb_auth_listener = %p.\n", __FUNCTION__, __FILE__, __LINE__, fd, adb_auth_listener);
    fdevent_install(&listener_fde, fd, adb_auth_listener, NULL);
    printf("function = %s, file = %s, line = %u, after fdevent_install and before fdevent_add \n", __FUNCTION__, __FILE__, __LINE__);

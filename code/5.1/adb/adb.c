...
void  adb_trace_init(void)
{
    ...
    const char*  q;
    printf("function = %s, file = %s, line = %u, getenv p = %s \n", __FUNCTION__, __FILE__, __LINE__, p);
...
static size_t fill_connect_data(char *buf, size_t bufsize)
{
    ...
    for (i = 0; i < num_cnxn_props; i++) {
        ...
        printf("function = %s, file = %s, line = %u, cnxn_props[%d] = %s, value = %s. \n", __FUNCTION__, __FILE__, __LINE__, i, cnxn_props[i], value);
...
void send_auth_request(atransport *t)
{
    ...
    printf("function = %s, file = %s, line = %u, before adb_auth_generate_token \n", __FUNCTION__, __FILE__, __LINE__);
...
{
    int port;
    printf("function = %s, file = %s, line = %u name = %s.\n", __FUNCTION__, __FILE__, __LINE__, name);
    ...
    if(!strncmp("tcp:", name, 4)){
        ...
        if (gListenAll > 0) {
            ...
            printf("function = %s, file = %s, line = %u, socket_inaddr_any_server. \n", __FUNCTION__, __FILE__, __LINE__);
        } else {
            ret = socket_loopback_server(port, SOCK_STREAM);
            printf("function = %s, file = %s, line = %u, socket_loopback_server. \n", __FUNCTION__, __FILE__, __LINE__);
        }
                                         ...
                                         int no_rebind)
{
    ...
    for(l = listener_list.next; l != &listener_list; l = l->next){
        if(strcmp(local_name, l->local_name) == 0) {
	       ...
	       printf("function = %s, file = %s, line = %u, before add_transport_disconnect \n", __FUNCTION__, __FILE__, __LINE__);
    ...
    printf("function = %s, file = %s, line = %u, l->fd = %d \n", __FUNCTION__, __FILE__, __LINE__, l->fd);
    if(l->fd < 0) {
    ...
    if(!strcmp(l->connect_to, "*smartsocket*")) {
        printf("function = %s, file = %s, line = %u, install_listener, before fdevent_install, fd = %d, ss_listener_event_func = %p \n", __FUNCTION__, __FILE__, __LINE__, l->fd, ss_listener_event_func);
        fdevent_install(&l->fde, l->fd, ss_listener_event_func, l);
    } else {
        printf("function = %s, file = %s, line = %u, install_listener, before fdevent_install, fd = %d, listener_event_func = %p \n", __FUNCTION__, __FILE__, __LINE__, l->fd, listener_event_func);
...
void start_device_log(void)
{
    ...
    printf("function = %s, file = %s, line = %u, property_get value = %s \n", __FUNCTION__, __FILE__, __LINE__, value);
...
int adb_main(int is_daemon, int server_port)
{
    ...
    printf("function = %s, file = %s, line = %u, before init_transport_registration \n", __FUNCTION__, __FILE__, __LINE__);
...
#endif
    printf("function = %s, file = %s, line = %u, before usb_vendors_init \n", __FUNCTION__, __FILE__, __LINE__);
    usb_vendors_init();
    usb_init();
    local_init(DEFAULT_ADB_LOCAL_TRANSPORT_PORT);
    printf("function = %s, file = %s, line = %u, before adb_auth_init \n", __FUNCTION__, __FILE__, __LINE__);
    adb_auth_init();

    char local_name[30];
    build_local_name(local_name, sizeof(local_name), server_port);
    printf("function = %s, file = %s, line = %u, before install_listener \n", __FUNCTION__, __FILE__, __LINE__);
    ...
    printf("function = %s, file = %s, line = %u, getenv adb_external_storage = %s. \n", __FUNCTION__, __FILE__,  __LINE__, adb_external_storage);
    ...
    */
    ...
    if (should_drop_privileges()) {
        ...
        printf("function = %s, file = %s, line = %u after should_drop_privileges\n", __FUNCTION__, __FILE__, __LINE__);
        ...
        char local_name[30];
        printf("function = %s, file = %s, line = %u, else should_drop_privileges\n", __FUNCTION__, __FILE__, __LINE__);
    ...
    if (access(USB_ADB_PATH, F_OK) == 0 || access(USB_FFS_ADB_EP0, F_OK) == 0) {
        // listen on USB
        printf("function = %s, file = %s, line = %u, access(USB) \n", __FUNCTION__, __FILE__, __LINE__);
        usb_init();
        usb = 1;
    }
    ...
    printf("function = %s, file = %s, line = %u, property_get service.adb.tcp.port value = %s. \n", __FUNCTION__, __FILE__, __LINE__, value);

    if (!value[0]) {
        property_get("persist.adb.tcp.port", value, "");
        printf("function = %s, file = %s, line = %u, property_get persist.adb.tcp.port value = %s. \n", __FUNCTION__, __FILE__, __LINE__, value);
    }
    if (sscanf(value, "%d", &port) == 1 && port > 0) {
        ...
        printf("function = %s, file = %s, line = %u, before local_init \n", __FUNCTION__, __FILE__, __LINE__);
        local_init(DEFAULT_ADB_LOCAL_TRANSPORT_PORT);
    }
...
{
#if ADB_HOST
    printf("function = %s, file = %s, line = %u, adb_host main\n", __FUNCTION__, __FILE__, __LINE__);
    adb_sysdeps_init();
    adb_trace_init();
    ...
    printf("function = %s, file = %s, line = %u, adbd \n", __FUNCTION__, __FILE__, __LINE__);
    adb_qemu_trace_init();
    while(1) {
        int c;
        int option_index = 0;

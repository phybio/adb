...
*/
#define DEBUG 1   /* non-0 will break adb server */
...
static void fdevent_init()
{
    ...
    printf("function = %s, file = %s, line = %u ?do not call this\n", __FUNCTION__, __FILE__, __LINE__);
...
static void fdevent_connect(fdevent *fde)
{
    ...
    ev.events = 0;
    ev.data.ptr = fde;
    printf("function = %s, file = %s, line = %u, call this, fde = %p \n", __FUNCTION__, __FILE__, __LINE__, fde);
...
static void fdevent_disconnect(fdevent *fde)
{
    ...
    printf("function = %s, file = %s, line = %u, fde = %p \n", __FUNCTION__, __FILE__, __LINE__, fde);
    memset(&ev, 0, sizeof(ev));
    ev.events = 0;
    ev.data.ptr = fde;
...
static void fdevent_process()
{
    ...
    printf("function = %s, file = %s, line = %u before epoll_wait\n", __FUNCTION__, __FILE__, __LINE__);
...
static void fdevent_connect(fdevent *fde)
{
    ...
    printf("function = %s, file = %s, line = %u, select_n = %d \n", __FUNCTION__, __FILE__, __LINE__, select_n);
}
...
static void fdevent_process()
{
    ...
    printf("function = %s, file = %s, line = %u before select *******\n", __FUNCTION__, __FILE__, __LINE__);
    ...
    for(i = 0; (i < select_n) && (n > 0); i++) {
        ...
        if(events) {
            ...
            printf("got events fde->fd=%d events=%04x, state=%04x\n",
...
static void fdevent_register(fdevent *fde)
{
    ...
    printf("function = %s, file = %s, line = %u, fde->fd = %d \n", __FUNCTION__, __FILE__, __LINE__, fde->fd);
    fd_table[fde->fd] = fde;
}
...
static void fdevent_call_fdfunc(fdevent* fde)
{
    ...
    fde->state &= (~FDE_PENDING);
    printf("function = %s, file = %s, line = %u, fde = %p, fde->func = %p \n", __FUNCTION__, __FILE__, __LINE__, fde, fde->func);
...
void fdevent_loop()
{
    ...
    for(;;) {
        ...
        fdevent_process();
        printf("function = %s, file = %s, line = %u, after fdevent_process \n", __FUNCTION__, __FILE__, __LINE__);

...
{
    printf("function = %s, file = %s, line = %u type = %d, serial = %s\n", __FUNCTION__, __FILE__, __LINE__, type, serial);
...
{
    printf("function = %s, file = %s, line = %u, service = %s. \n", __FUNCTION__, __FILE__, __LINE__, service);
    char tmp[5];
    int len;
    int fd;
    ...
    if (__adb_server_name) {
        ...
        printf("function = %s, file = %s, line = %u, __adb_server_name = %s. \n", __FUNCTION__, __FILE__, __LINE__, __adb_server_name);
    }
    else{
        fd = socket_loopback_client(__adb_server_port, SOCK_STREAM);
        printf("function = %s, file = %s, line = %u, socket_loopback_client, fd = %d \n", __FUNCTION__, __FILE__, __LINE__, fd);
     }

    printf("function = %s, file = %s, line = %u, __adb_server_port = %d, fd = %d. \n", __FUNCTION__, __FILE__, __LINE__, __adb_server_port, fd);

...
asocket *create_local_socket(int fd)
{
    ...
    printf("function = %s, file = %s, line = %u create_local_socket, fd = %d, local_socket_event_func = %p.\n", __FUNCTION__, __FILE__, __LINE__, fd, local_socket_event_func);
...
asocket *create_local_service_socket(const char *name)
{
    ...
    if (!strncmp(name, "root:", 5))
        ...
        printf("function = %s, file = %s, line = %u property_get debug = %s. \n", __FUNCTION__, __FILE__, __LINE__, debug);
